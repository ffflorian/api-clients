...
export class DiagnosisKeysAPI {
   ...
   * (if all of them contain diagnosis keys).
   */
   ...
   * within the 14-day window), a signed payload with an
   * empty list of diagnosis keys will be returned. If
   * the date is outside of the 14-day window, or in the
   * future, an HTTP error code will be returned.
   */
   ...
   * containing the respective numbers/hours for which data
   * is available (e.g. 0-17) will be returned. If the date
