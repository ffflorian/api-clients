...
describe('Endpoint', () => {
  it.each([
    ...
    ['comment edit', Endpoint.Comments.editComment('42'), '/comments/42/edit.json'],
    ['object comments', Endpoint.Comments.objectComments('42'), '/objects/42/comments.json'],
    ['comment recovery', Endpoint.Comments.recoveryComment('42'), '/comments/42/recovery.json'],
    ['comment trash', Endpoint.Comments.trashComment('42'), '/comments/42/trash.json'],
    ['comment best toggle', Endpoint.Comments.toggleBestComment('42'), '/comments/42/best/toggle.json'],
    ['comment vote toggle', Endpoint.Comments.toggleVoteComment('42'), '/comments/42/votes/toggle.json'],
    ...
    ['object search', Endpoint.Objects.search(), '/search.json'],
    ...
    ['object custom fields', Endpoint.CustomFields.objectCustomFields(), '/objects/custom-fields/list.json'],
